...
def generate_first_line(company_name, website, linkedin, address):
    ...
    prompt = (
        ...
        "Rule 3: Try to follow this pattern: 'I enjoyed your recent [specific content] about [topic]. Your approach to [specific aspect] would resonate perfectly with education-focused families.'\n"
        "Rule 4: Don't cringe. Use a professional but conversational tone.\n"
        "Rule 5: Always refer to the brand as 'you' or 'your.'\n"
        "Rule 6: Keep it under 24 words.\n"
        "Rule 7: Only write 2 sentences.\n"
...
with open(input_file, mode="r", encoding="utf-8") as infile, open(output_file, mode="w", encoding="utf-8", newline="") as outfile:
    ...
    for row in reader:
        ...
        if not company_name and not website and not linkedin and not address:
            ...
            row["First Line"] = generate_first_line(company_name, website, linkedin, address)
